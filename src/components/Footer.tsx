    ...
    <footer className="bg-slate-50 border-t border-slate-200 py-16">
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-start max-w-sm">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-start mt-4 md:mt-0">
            ...
            <div className="flex items-center gap-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white rounded-xl text-slate-500 hover:text-accent hover:bg-slate-100 transition-all border border-slate-200 hover:shadow-md">
                <Briefcase size={20} />
              </a>
              <a href="mailto:prashantmane572@gmail.com" className="p-2.5 bg-white rounded-xl text-slate-500 hover:text-accent hover:bg-slate-100 transition-all border border-slate-200 hover:shadow-md">
                <Mail size={20} />
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white rounded-xl text-slate-500 hover:text-accent hover:bg-slate-100 transition-all border border-slate-200 hover:shadow-md">
                <Globe size={20} />
              </a>
            </div>
          </div>
